    ...
    public partial class NewMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3c09c996-5113-458d-9ca2-45f6dcf390eb", null, "admin", "admin" },
                    { "91ccc634-91f2-4411-a974-91b32633317f", null, "seller", "seller" },
                    { "fdaff8bf-cc35-40ed-9d8a-058a47158416", null, "client", "client" }
                });

            migrationBuilder.InsertData(
                table: "Hotels",
                columns: new[] { "HotelID", "DoublePrice", "FamilyPrice", "HotelLocation", "HotelName", "SinglePrice" },
                values: new object[,]
                {
                    { 1, 775, 950, "London", "Hilton London Hotel", 375 },
                    { 2, 500, 900, "London", "London Marriott Hotel", 300 },
                    { 3, 120, 150, "Brighton", "Travelodge Brighton Seafront", 80 },
                    { 4, 400, 520, "Brighton", "Kings Hotel Brighton", 180 },
                    { 5, 400, 520, "Brighton", "Leonardo Hotel Brighton", 180 },
                    { 6, 100, 155, "Fort William", "Nevis Bank Inn, Fort William", 90 }
                });
